...
import '../provider/screen/Provider shop/Provider_ShopScreen.dart';
...
class NavigationController extends GetxController{
  ...
  final screens = [const Home(), User_ShopScreen(), Container(color: Colors.purple,), const SettingScreen()];
}
