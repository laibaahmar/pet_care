...
import 'package:pet/features/provider/screen/Provider%20shop/Provider_ShopScreen.dart';
...
class NavigationController extends GetxController{
  ...
  final screens = [const ProviderHomeScreen(), ProviderShopScreen(), Container(color: Colors.purple,), const ProviderSettingScreen()];
}
